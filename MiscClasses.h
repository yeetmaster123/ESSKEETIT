...
public:
	...
	IClientEntity *GetClientEntityFromHandleknife(HANDLE hEnt)
	{
		typedef IClientEntity* (__thiscall* OriginalFn)(PVOID, HANDLE);
		return call_vfunc<OriginalFn>(this, 4)(this, hEnt);
	}
	IClientEntity* GetClientEntityFromHandlexd(void* handle)
	{
		typedef IClientEntity*(__thiscall* Fn)(void*, void*);
		return call_vfunc<Fn>(this, 4)(this, handle);
	}
	int xdGetHighestEntityIndex()
	{
		typedef int(__thiscall* Fn)(void*);
		return call_vfunc<Fn>(this, 6)(this);
	}
};
