...
namespace ImGui
{
	...
	IMGUI_API bool          MyColorPicker3(const char* label, float col[3], ImGuiColorEditFlags flags = 0);
	IMGUI_API bool			MyColorPicker4(const char* label, float col[4], ImGuiColorEditFlags flags = 0x01);;
	...
	IMGUI_API bool BeginChildNew(const char* str_id, const ImVec2& size_arg, bool border, ImGuiWindowFlags extra_flags);
	IMGUI_API void RenderCheckMark1(ImVec2 pos, ImU32 col, float sz);
	...
	IMGUI_API bool MyButtonExXD(const char * label, const ImVec2 & size_arg, bool inuse, ImGuiButtonFlags flags);
	IMGUI_API bool MyButton(const char * label, bool inuse, const ImVec2 & size_arg);
...
enum ImGuiWindowFlags_
{
	...
	ImGuiWindowFlags_ChildZeus = 1 << 19,
...
enum ImGuiCol_
{
	...
	ImGuiCol_CheckMarkBg,
	ImGuiCol_CheckMarkHover,
