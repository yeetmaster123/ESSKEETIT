...
public:
	...
	void IPlaySound(const char* fileName)
	{
		...
		return call_vfunc< OriginalFn >(this, 82)(this, fileName);
	}
	...
	void DrawPrintTextxd(const wchar_t* Text, int Len, int DrawType = 0)
	{
		typedef void(__thiscall* Fn)(void*, wchar_t const*, int, int);
		return ((Fn)call_vfunc<Fn>(this, 28))(this, Text, Len, DrawType);
	}
