...
private:
	Color get_player_colors(IClientEntity* m_entity) {
		...
		return Color(Shonax::settingsxd.espboxcolor[0]*255, Shonax::settingsxd.espboxcolor[1] * 255, Shonax::settingsxd.espboxcolor[2] * 255, Shonax::settingsxd.espboxcolor[3] * 255);
	}
